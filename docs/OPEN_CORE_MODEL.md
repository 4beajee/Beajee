...
> Beajee использует **GitLab-style open core**: базис фреймворка открыт,
...
2. **Self-hosters становятся адвокатами** — команды, деплоящие Beajee локально, распространяют бренд.
...
| **Beajee** | Team Framework базис | Облачная сеть, аналитика | Протокол открыт, сеть — продукт |
