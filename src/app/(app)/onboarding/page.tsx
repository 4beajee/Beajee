    ...
    case "perplexity_personal_computer":
      return (
        <svg
          ...
          aria-hidden="true"
        >
          <title>Perplexity Personal Computer</title>
